...
void* percorrer_Casos_QD(Tree arvoreCasos, char id[], PosicNo n){
    /*if(strcmp(id,get(getElement(arvoreCasos,n)))==0){
        // return getElement(arvoreCasos,n);
        return n;
    }*/

    ItemNode resposta = NULL;

    if(leafNe(arvoreCasos,n) == 1)
        resposta = percorrer_RB_QD(arvoreCasos,id,getNe(arvoreCasos,n));
    ...
    if(leafNw((arvoreCasos),n) == 1)
        resposta = percorrer_RB_QD(arvoreCasos,id,getNw(arvoreCasos,n));
    ...
    if(leafSe((arvoreCasos),n) == 1)
        resposta = percorrer_RB_QD(arvoreCasos,id,getSe(arvoreCasos,n));
    ...
    if(leafSw((arvoreCasos),n) == 1)
        resposta = percorrer_RB_QD(arvoreCasos,id,getSw(arvoreCasos,n));
...
void* percorrer_Quadra_dd(Tree arvoreQuadra, PosicNo aux, double x, double w, double y, double h) {
    ...
    if(true) {
        ...
        if(getXQuadra(quadra) <= getXForma(retangulo) + getWQuadra(quadra) && getYQuadra(quadra) <= getYForma(retangulo) + getHForma(retangulo) &&  getXQuadra(quadra) + getWQuadra(quadra) >= getXForma(retangulo) && getYQuadra(quadra) + getHQuadra(quadra) >= getYForma(retangulo)){
            numQuadrasDentro++;
        }
    }
...
void* inputSombraQuadras(Tree arvoreQuadra, PosicNo aux, FILE* svg, double densidadeQuadra, double x, double y, double w, double h){
    ...
    if(getXQuadra(quadra) <= getXForma(retangulo) + getWQuadra(quadra) && getYQuadra(quadra) <= getYForma(retangulo) + getHForma(retangulo) &&  getXQuadra(quadra) + getWQuadra(quadra) >= getXForma(retangulo) && getYQuadra(quadra) + getHQuadra(quadra) >= getYForma(retangulo)) {
        if(densidadeQuadra >= 10 && densidadeQuadra < 500){
            svg_drop_shadow(svg, getXQuadra(quadra), getYQuadra(quadra), getWQuadra(quadra), getHQuadra(quadra),
                            "#FFFF00", getcorBordaQuadra(quadra), getcorPreenchimentoQuadra(quadra));
        }
        if(densidadeQuadra >= 500 && densidadeQuadra < 1500){
            printf("\ndensidade 2: %lf\n", densidadeQuadra);
            svg_drop_shadow(svg, getXQuadra(quadra), getYQuadra(quadra), getWQuadra(quadra), getHQuadra(quadra),
                            "#FF9955", getcorBordaQuadra(quadra), getcorPreenchimentoQuadra(quadra));
        }
        if(densidadeQuadra >= 1500 && densidadeQuadra < 3000){
            printf("\ndensidade 3: %lf\n", densidadeQuadra);
            svg_drop_shadow(svg, getXQuadra(quadra), getYQuadra(quadra), getWQuadra(quadra), getHQuadra(quadra),
                            "#FF0000", getcorBordaQuadra(quadra), getcorPreenchimentoQuadra(quadra));
        }
        if(densidadeQuadra >= 3000 && densidadeQuadra < 4500){
            printf("\ndensidade 4: %lf\n", densidadeQuadra);
            svg_drop_shadow(svg, getXQuadra(quadra), getYQuadra(quadra), getWQuadra(quadra), getHQuadra(quadra),
                            "#FF00CC", getcorBordaQuadra(quadra), getcorPreenchimentoQuadra(quadra));
        }
        if(densidadeQuadra >= 4500 && densidadeQuadra < 6000){
            printf("\ndensidade 5: %lf\n", densidadeQuadra);
            svg_drop_shadow(svg, getXQuadra(quadra), getYQuadra(quadra), getWQuadra(quadra), getHQuadra(quadra),
                            "#6600FF", getcorBordaQuadra(quadra), getcorPreenchimentoQuadra(quadra));
        }
        if(densidadeQuadra >= 6000){
            printf("\ndensidade 6: %lf\n", densidadeQuadra);
            svg_drop_shadow(svg, getXQuadra(quadra), getYQuadra(quadra), getWQuadra(quadra), getHQuadra(quadra),
                            "#A02C5A", getcorBordaQuadra(quadra), getcorPreenchimentoQuadra(quadra));
        }
    }
    ItemNode resposta = NULL;
